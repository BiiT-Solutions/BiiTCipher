package com.biit.cipher.logger;
 ...
 */
public class CipherLogger extends BiitLogger {

    private static final Logger logger = LoggerFactory.getLogger(CipherLogger.class);
